...
public class NineTarock extends Figure
{
	public NineTarock(Memory memory, Personality personality)
	{
	...
	{
		if (memory.getMyCards().getTarockCount() == 9)
		{
			return Collections.singletonList(new AnnouncementContra(Announcements.kilenctarokk, -1));
		}
